...
import '../screens/identity_claims_screen.dart';
import '../../core/org/org_service.dart';
import '../screens/my_organizations_screen.dart';
import '../../core/chain/chain_exporter.dart';
import '../screens/org_claims_screen.dart';
        ...
        children: [
          ...
          Card(
            child: ListTile(
              ...
              subtitle: const Text('Social, legal, GLUE identifiers'),
              trailing: const Icon(Icons.chevron_right),
              onTap: () => Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => OrgClaimsScreen(
                    namespace: 'ulissy',
                    adminPk: widget.wallet.publicKey ?? '',
                    organizationName: 'Ulissy',
                    domain: 'ulissy.com',
                  ),
                ),
              ),

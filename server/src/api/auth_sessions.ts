...
// ===========================================
router.post('/session/request', async (req: Request, res: Response) => {
  try {
...
// ===========================================
router.post('/session/approve', async (req: Request, res: Response) => {
  try {
...
// ===========================================
router.post('/session/reject', async (req: Request, res: Response) => {
  try {
...
// ===========================================
router.delete('/session/:token', async (req: Request, res: Response) => {
  try {
